      ...
      <div className="mt-4 rounded-xl border border-white/10 bg-slate-900/70 px-4 py-3 text-sm">
        ...
        <div className="mt-4 border-t border-white/5 pt-3">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center rounded-md bg-cyan-400/10 px-2 py-0.5 text-xs font-medium text-cyan-200 ring-1 ring-inset ring-cyan-400/20">v1.7.0</span>
            <span className="text-xs text-slate-500">BUILD: bg-v17-draftjs-fix</span>
          </div>
