    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        <div className={cn(aiGlassPanel, "space-y-2 p-4 md:col-span-2")}>
          ...
          <p className="text-xs text-gray-500">客户真正买的不是产品名称，而是你解决的问题。</p>
        ...
        <div className={cn(aiGlassPanel, "space-y-2 p-4")}>
          ...
          <p className="text-xs text-gray-500">建议 3 条：每条写清一个差异化价值，回车添加。</p>
        ...
        <div className={cn(aiGlassPanel, "space-y-2 p-4")}>
          ...
          <p className="text-xs text-gray-500">从接触到交付的关键步骤，帮助 AI 理解你的交付方式。</p>
        ...
        <div className={cn(aiGlassPanel, "space-y-2 p-4")}>
          ...
          <p className="text-xs text-gray-500">可写区间或起步价，避免空泛「面议」。</p>
        ...
        <div className={cn(aiGlassPanel, "space-y-2 p-4 md:col-span-2")}>
          ...
          <p className="text-xs text-gray-500">与主要竞品相比，客户为什么选你而不是别人。</p>
        ...
        <div className={cn(aiGlassPanel, "space-y-2 p-4 md:col-span-2")}>
          ...
          <p className="text-xs text-gray-500">明确边界可减少无效线索，也让 AI 引用更可信。</p>
