    ...
    <div className="mx-auto max-w-4xl space-y-6 pb-12 pt-6 text-gray-900">
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardHeader>
          ...
          <CardDescription className="text-blue-600">本页展示该次测试的关键结论</CardDescription>
        </CardHeader>
      ...
      <EvidenceSection title="品牌识别结果">
        <ul className="space-y-2 text-sm text-gray-600">
          ...
          <li>
            判断依据片段：
            <span className="mt-1 block rounded-lg bg-gray-100 p-3 text-gray-500">{evidence.brandMentionExcerpt}</span>
          </li>
        </ul>
      </EvidenceSection>
        ...
        {!evidence.competitorConfigured ? (
          ...
          <div className="space-y-3">
            {evidence.competitorMentions.map(c => (
              <div key={c.name} className="rounded-xl border border-gray-200 bg-gray-50 p-3 text-sm">
