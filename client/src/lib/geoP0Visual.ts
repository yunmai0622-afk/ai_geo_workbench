...
export function stageBadgeClass(stageLabel: string): string {
  ...
  const tones: Record<string, string> = {
    ...
    实测已完成: `${base} bg-emerald-50 text-emerald-700 border border-emerald-200`,
    本月计划执行中: `${base} bg-violet-50 text-violet-700 border border-violet-200`,
    等待复测: `${base} bg-sky-50 text-sky-700 border border-sky-200`,
    可执行复测: `${base} bg-sky-50 text-sky-700 border border-sky-200`,
    本月计划已完成: `${base} bg-emerald-50 text-emerald-700 border border-emerald-200`,
    待制定本月计划: `${base} bg-blue-50 text-blue-700 border border-blue-200`,
