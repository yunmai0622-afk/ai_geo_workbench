...
export const demoMetrics: DemoMetric[] = [
  { label: "GEO 总分", value: "32", note: "试跑后当前得分（弱可见向上）", tone: "cyan" },
...
export const demoT0Detection = {
  ...
  summary:
    "优化前基线显示：品牌在 10 条客户指定问题中仅弱可见，公开证据与 AI 可引用片段不足，竞品（小鹅通、有赞教育）在通用选型问题中更易被提及。",
} as const;
...
export const demoT0T1Comparison = {
  ...
  rows: [
    { metric: "GEO 总分", t0: "32", t1: "32", change: "持平" },
