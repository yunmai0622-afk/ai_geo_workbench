...
CREATE TABLE `understanding_assessment_dimension_results` (
	...
	`dimension` enum('identity','business','capability','boundary','temporal','evidence','consistency','uncertainty','category','products_services','customers','scenarios','capability_differentiation','boundary_temporal') NOT NULL,
