...
CREATE TABLE `understanding_correction_tasks` (
	...
	`verificationQuestionIds` json NOT NULL DEFAULT ('[]'),
...
CREATE TABLE `understanding_dimension_results` (
	...
	`expectedFacts` json NOT NULL DEFAULT ('[]'),
	`actualStatements` json NOT NULL DEFAULT ('[]'),
	`matchedFacts` json NOT NULL DEFAULT ('[]'),
	`missingFacts` json NOT NULL DEFAULT ('[]'),
	`inaccurateFacts` json NOT NULL DEFAULT ('[]'),
	`outdatedFacts` json NOT NULL DEFAULT ('[]'),
	`conflictingFacts` json NOT NULL DEFAULT ('[]'),
	`hallucinatedClaims` json NOT NULL DEFAULT ('[]'),
	`unverifiableClaims` json NOT NULL DEFAULT ('[]'),
	`evidenceReferences` json NOT NULL DEFAULT ('[]'),
	`severity` enum('P0','P1','P2') NOT NULL DEFAULT 'P2',
...
CREATE TABLE `understanding_evaluations` (
	...
	`uncertainStatements` json NOT NULL DEFAULT ('[]'),
...
CREATE TABLE `understanding_questions` (
	...
	`verificationFactKeys` json NOT NULL DEFAULT ('[]'),
