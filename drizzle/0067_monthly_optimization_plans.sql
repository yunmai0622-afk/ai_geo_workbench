...
CREATE INDEX `monthly_optimization_plans_project_status_idx` ON `monthly_optimization_plans` (`projectId`,`status`);

CREATE TABLE IF NOT EXISTS `monthly_optimization_tasks` (
	`id` int AUTO_INCREMENT NOT NULL,
	`planId` int NOT NULL,
	`projectId` int NOT NULL,
	`taskType` enum('content_generation','source_discovery','evidence_addition','profile_completion') NOT NULL,
