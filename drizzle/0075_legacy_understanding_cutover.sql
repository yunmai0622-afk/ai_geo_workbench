CREATE TABLE IF NOT EXISTS `legacy_understanding_migration_runs` (
...
CREATE TABLE IF NOT EXISTS `legacy_understanding_migration_items` (
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `understanding_rollout_configs` (
