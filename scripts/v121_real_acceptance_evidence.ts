  ...
  const output = {
    ...
    publishEvidence: {
      ...
      monitoringRecord: {
        ...
        inclusionStatus: monitorRows[0].inclusionMonitorStatus,
        aiMentionStatus: monitorRows[0].aiMentionMonitorStatus,
        aiRecommendStatus: monitorRows[0].aiRecommendMonitorStatus,
