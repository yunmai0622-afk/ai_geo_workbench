...
const COLUMNS = [
  ...
  ["effectInclusionStatus", "ADD COLUMN `effectInclusionStatus` varchar(32) NULL"],
  ["inclusionVerifiedAt", "ADD COLUMN `inclusionVerifiedAt` timestamp NULL"],
  ["inclusionKeywords", "ADD COLUMN `inclusionKeywords` json NULL"],
  ["readCount", "ADD COLUMN `readCount` int NULL"],
  ["impressionCount", "ADD COLUMN `impressionCount` int NULL"],
  ["interactionCount", "ADD COLUMN `interactionCount` int NULL"],
  ["searchTriggerKeywords", "ADD COLUMN `searchTriggerKeywords` json NULL"],
  ["effectDataSource", "ADD COLUMN `effectDataSource` varchar(32) NULL"],
  ["evidenceScreenshotUrl", "ADD COLUMN `evidenceScreenshotUrl` varchar(2000) NULL"],
  ["evidenceNotes", "ADD COLUMN `evidenceNotes` text NULL"],
