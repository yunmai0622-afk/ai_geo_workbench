...
const BASELINE_PATH = "drizzle/baselines/tidb_v0075.sql";
...
export async function bootstrapTidbV0075(connection, options = {}) {
...
async function main() {
  ...
  try {
    ...
    const result = await bootstrapTidbV0075(connection);
