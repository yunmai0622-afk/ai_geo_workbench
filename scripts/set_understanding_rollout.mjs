...
if (!Number.isInteger(projectId) || projectId <= 0 || projectId === 210001) throw new Error("invalid or blocked projectId");
if (!["legacy_only", "shadow_read", "v2_primary", "v2_only"].includes(mode)) throw new Error("invalid --mode");
if (mode !== "legacy_only" && process.env.AI_OBSERVATION_LEDGER_V2?.toLowerCase() !== "true") throw new Error("global v2 feature flag is disabled");
